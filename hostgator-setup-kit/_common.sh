...
# que trocar junto.
# ⚠️ FORK. O upstream publica em `ghcr.io/melgarafael`; esta instalação publica
# no próprio namespace, pela receita que `tests/unit/namespace-das-imagens.test.ts`
# documenta em `RECADO_AO_FORK`. Esta linha NUNCA vai num PR para o upstream.
IMG_NS="ghcr.io/paulolimajr77"
...
ultima_versao_publicada() {
  local url="${1:-https://github.com/paulolimajr77/DeskcommCRM.git}" ref
