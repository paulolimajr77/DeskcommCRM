...
export async function moverLeadParaEtapaDeHandoff(
  ...
  // Passar o atendimento para um humano é uma transferência, não a confirmação
  // de que o fato aconteceu. Se a etapa de destino afirma um fato, quem o
  // afirma é uma pessoa — este movedor é máquina (`webhook_source`). Etapa com
  // `afirma_fato = false` passa direto: é o padrão, e o estado de 100% das
  // etapas existentes.
