-- 0268 — o agente PROPÕE um campo de funil, e a Central avisa.
--
-- ─── O que muda ─────────────────────────────────────────────────────────────
--
...
-- lead (e vivem em `contact_field_proposals`, com destino desde a 0267); criar
...
-- primeiro conserto feito de um lado só. É o mesmo argumento que a 0267 já fez
...
-- motivo está no cabeçalho da 0265: o mecanismo que a usaria não tinha sido
...
-- ⚠️ CONSERTO OBRIGATÓRIO NO MESMO ARQUIVO — a mesma razão da 0265.
--
...
--
-- O corpo abaixo é DERIVADO do que está em vigor (a 0265): recriá-lo de um
...
-- a segunda sugestão em silêncio, que é o defeito que a 0267 evitou do outro
-- lado.
--
...
-- qualquer tenant — foi o vermelho que a 0266 pagou.
