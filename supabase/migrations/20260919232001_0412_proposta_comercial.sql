...
alter table public.agent_inbox_items
  add constraint agent_inbox_items_kind_check check (kind in (
    ...
    -- campos do funil (migrations 0284, 0287 na vps/pljr-combinada — essa
    -- feature nunca existiu na linha da proposta comercial; união dos dois
    -- lados no merge de 25/09/2026, para não encolher o vocabulário que já
    -- está em produção):
