...
// ⚠️ FORK: este clone publica as próprias imagens. O upstream é
// `ghcr.io/melgarafael`; as duas menções em prosa acima e abaixo continuam
// falando DELE de propósito — são história, não configuração.
const NAMESPACE_DESTE_REPO = "ghcr.io/paulolimajr77";
...
describe("o kit aponta para o que o CI realmente publica", () => {
  it("os defaults de código e os labels de origem apontam para este repositório", () => {
    // ⚠️ FORK: a URL do repositório acompanha o namespace. O upstream é
    // `melgarafael`; este clone publica e clona do próprio.
    const repo = "https://github.com/paulolimajr77/DeskcommCRM";
